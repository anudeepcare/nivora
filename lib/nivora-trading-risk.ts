...
export const TRADING_RISK_VERSION="v63-paper-risk-1" as const;
...
export type TradingRiskContext={equity:number;cash:number;dailyPnlPct:number;currentPositionValue:number;openPositions:number;duplicate:boolean;quote:{price:number;ageSeconds:number|null;freshness:"LIVE"|"STALE"|"LAST_TRADE";changePct?:number|null;spreadPct?:number|null;integrityState?:"LIVE_VERIFIED"|"LIVE_SINGLE_SOURCE"|"DELAYED"|"STALE"|"DISAGREEMENT"|"MARKET_CLOSED"}};
