...
export function validateQuoteIdentity(expectedSymbol:string,quote:{symbol?:string|null;provider?:string|null;exchange?:string|null;currency?:string|null},hint:{exchange?:string;currency?:string}={}){
