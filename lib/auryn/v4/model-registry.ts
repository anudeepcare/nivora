...
const common={version:"auryn-v4.2-model-1",allowOptionalRenormalization:true,maxActionWhenSuitabilityLow:"HOLD" as const};
...
export const ANALYST_MODELS:AnalystModelDefinition[]=[
  ...
  {...common,id:"digital-health-platform",businessModels:["DIGITAL_HEALTH_PLATFORM"],factorWeights:{BUSINESS_QUALITY:.14,GROWTH_INFLECTION:.17,MOAT:.12,NARRATIVE_EXPECTATIONS:.06,FUNDAMENTALS_EARNINGS:.12,VALUATION:.10,TECHNICALS:.05,POSITIONING:.02,CATALYSTS:.08,SECTOR_INDUSTRY:.04,MACRO_REGIME:.01,RISK:.09},requiredFactors:["BUSINESS_QUALITY","GROWTH_INFLECTION","RISK"],optionalFactors:["MOAT","NARRATIVE_EXPECTATIONS","FUNDAMENTALS_EARNINGS","VALUATION","TECHNICALS","POSITIONING","CATALYSTS","SECTOR_INDUSTRY","MACRO_REGIME"]},
  ...
  {...common,id:"ai-power-infrastructure",businessModels:["AI_DATA_CENTER_INFRA","POWER_UTILITY_INFRA"],factorWeights:{BUSINESS_QUALITY:.10,GROWTH_INFLECTION:.15,MOAT:.10,NARRATIVE_EXPECTATIONS:.07,FUNDAMENTALS_EARNINGS:.10,VALUATION:.10,TECHNICALS:.06,POSITIONING:.03,CATALYSTS:.10,SECTOR_INDUSTRY:.07,MACRO_REGIME:.03,RISK:.09},requiredFactors:["GROWTH_INFLECTION","FUNDAMENTALS_EARNINGS","RISK"],optionalFactors:["BUSINESS_QUALITY","MOAT","NARRATIVE_EXPECTATIONS","VALUATION","TECHNICALS","POSITIONING","CATALYSTS","SECTOR_INDUSTRY","MACRO_REGIME"]},
