...
const zone = (label, center, width, multiplier, basis) => ({ label, low: round(center - width), high: round(center + width), multiplier, basis });
const buyLike = (a) => a === 'BUY' || a === 'STRONG_BUY';
function buildExecutionPlan({ marketTruth, technical, thesis, riskScore, primaryAction = 'BUY', ownerAction = 'BUY', valuationDecisionGrade = true }) {
