...
test("info affordance is visibly circled and keeps large hit target",()=>{assert.match(info,/v6516InfoGlyph/);assert.match(info,/CircleHelp/);assert.match(css,/\.v658InfoButton::after\{[^}]*inset:-11px/s);assert.match(css,/\.v6516InfoGlyph/)});
