...
test("metric help uses one glyph and viewport-safe positioning",()=>{const m=read("components/v65/MetricInfo.tsx"),c=read("app/globals.css");assert.match(m,/v6516InfoGlyph/);assert.match(c,/\.v656MetricSheet/);assert.match(c,/position:absolute/);});
