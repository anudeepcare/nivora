...
test("overview presents richer technical evidence cleanly",()=>{for(const x of ["Weekly HMA","Volume vs avg","Accumulation","Trend channel","Confluence"])assert.ok(v.includes(x),x);});
