...
test("V60 hardening versions preserve V59 scoring weights",()=>{assert.equal(ENGINE_VERSION,"v60");assert.equal(WEIGHTS_VERSION,"v59-thesis-1");assert.equal(TODAY_POLICY_VERSION,"v60-live-today-1")});
