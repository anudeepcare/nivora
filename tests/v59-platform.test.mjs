...
test("V59 canonical versions are explicit",()=>{assert.equal(ENGINE_VERSION,"v59");assert.equal(WEIGHTS_VERSION,"v59-thesis-1");assert.equal(TODAY_POLICY_VERSION,"v59-today-1")});
