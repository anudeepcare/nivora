...
test("V61 Trading Lab preserves V59 scoring weights",()=>{assert.equal(ENGINE_VERSION,"v63");assert.equal(WEIGHTS_VERSION,"v59-thesis-1");assert.equal(TODAY_POLICY_VERSION,"v63-reality-today-1")});
