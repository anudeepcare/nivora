...
test('Trading Lab page clearly says paper trading and earned results',()=>{assert.match(page,/PAPER/i);assert.match(page,/Profit factor/i);assert.match(page,/Win rate/i);assert.match(page,/Live-money auto execution remains disabled|No live-money auto execution/i)});
