...
test("V2 has richer valuation/timing/scenario and collision lanes",()=>{for(const x of ["vs History","vs Peers","Growth Adj","FCF yield","Momentum","Participation","Relative strength","Current","decisionLane","Bear case","Base case","Bull case"])assert.match(v2,new RegExp(x,"i"));});
