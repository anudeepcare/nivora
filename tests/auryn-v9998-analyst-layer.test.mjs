...
test("fundamental scenarios never silently reuse technical scenario map",()=>{assert.match(ui,/fundamentalScenario/);assert.match(ui,/Independent fundamental valuation unavailable/);});
