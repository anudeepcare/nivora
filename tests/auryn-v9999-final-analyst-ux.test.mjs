...
test("three clocks expose decision submetrics and evidence state",()=>{for(const x of ["Growth / quality","Forward evidence","Margin of safety","Market structure","Entry quality","Evidence"])assert.match(ui,new RegExp(x,"i"));});
