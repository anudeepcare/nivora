...
import {House,Search,Compass,BriefcaseBusiness,UserRound,Bell,Info,ShieldCheck,Star} from "lucide-react";
 ...
 return <>
  <header className="osHeader v12Header">
   ...
   <nav className="osDesktopNav" aria-label="Primary">
    ...
    <Link className={active("/discover")?"on":""} href="/discover">Discover</Link>
  ...
  <nav className="osMobileNav v12MobileNav" aria-label="Mobile navigation">
   ...
   <Link className={active("/discover")?"on":""} href="/discover"><Compass size={19}/><span>Discover</span></Link>
