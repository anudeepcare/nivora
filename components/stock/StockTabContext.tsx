...
export default function StockTabContext({label,title,score,state,action,detail,marketTruth}:{label:string;title:string;score?:number|null;state?:string|null;action?:PrimaryInvestmentAction|null;detail:string;marketTruth?:any}){
