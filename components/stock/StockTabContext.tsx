...
export default function StockTabContext({label,title,score,state,detail,marketTruth}:{label:string;title:string;score?:number|null;state?:string|null;action?:PrimaryInvestmentAction|InstitutionalNewMoneyAction|null;detail:string;marketTruth?:any}){
  const blocked=marketTruth?.priceSensitiveAllowed===false;
  return <header className="aurynTabContext v932TabContext">
