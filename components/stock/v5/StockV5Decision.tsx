...
export default function StockV5Decision({snapshot,owns,depth,onDepthChange}:{snapshot:CanonicalAnalysisSnapshot;owns:boolean;depth:Depth;onDepthChange?:(x:Depth)=>void}){
