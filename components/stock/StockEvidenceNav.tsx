"use client";
const tabs=[['thesis','Thesis'],['fundamentals','Business'],['earnings','Earnings'],['technical','Technicals'],['institutions','Ownership'],['catalysts','Catalysts'],['options','Options']] as const;
