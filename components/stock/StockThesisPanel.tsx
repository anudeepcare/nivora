...
export default function StockThesisPanel({decision,metricDefinitions,v4,marketTruth}:{decision:any;metricDefinitions:any;v4?:AurynV4CoreAnalysis|null;marketTruth?:any}){
 if(v4){
  ...
  return <div className="aurynStockTabPage aurynThesis">
   ...
   <div className="aurynThesisScoreGuide"><b>One canonical brain</b><span>{marketBlocked?"Market price is unverified. Thesis/business evidence remains visible, while price-sensitive actions are blocked.":"Every tab below explains a factor feeding the V4 decision. Missing evidence shows N/A and never becomes a bearish zero."}</span></div>
