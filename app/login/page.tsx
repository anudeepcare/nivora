...
export default function Login(){
 ...
 return <main className="osAuth v44Auth">
  ...
  <section className="v44AuthShell">
   <aside className="v44AuthStory"><div className="v44AuthMark"><Sparkles size={18}/></div><small>YOUR INVESTMENT INTELLIGENCE</small><h2>Know what to do next. See exactly why.</h2><p>From long-term thesis to today’s entry decision, NIVORA puts the answer first and the evidence one step behind it.</p><div className="v44AuthPoints"><span><CheckCircle2 size={16}/>Decision-first stock research</span><span><CheckCircle2 size={16}/>Portfolio and watchlist context</span><span><ShieldCheck size={16}/>Evidence, limitations and risk shown clearly</span></div><div className="v44AuthLegal">Research and decision-support only. No guaranteed outcomes.</div></aside>
