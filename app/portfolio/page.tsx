...
import {Trash2,Pencil,Check,X,Sparkles,ShieldCheck,Search,WalletCards,Bitcoin,Banknote,MoreHorizontal} from "lucide-react";
...
function PortfolioContent(){
 ...
 return <section className="portfolioPage v65Portfolio v653Portfolio">
  ...
  <div className="v653HoldingsHead"><div><small>POSITIONS</small><h2>Your holdings</h2><em>{investedRows.length.toLocaleString()} investments</em></div><span>Sorted as tracked · open any name for the full decision.</span></div>
