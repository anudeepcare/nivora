...
try{
 ...
 return NextResponse.json({name:entry.title,cik,assetType:"stock",freshness:{fundamentalsAt:nowIso(),fundamentalsTtlSeconds:21600,filingsTtlSeconds:300},evidence,latestQuarter,fundamentals,fundamentalSignal,fiveYearRecord,filings,filingRisk,rawMetrics:{revenue:rev,revGrowth,niGrowth,netIncome:ni,fcf,opMargin,grossMargin,leverage}});
