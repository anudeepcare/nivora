...
export async function POST(req:Request){
 try{
  ...
  const db=createClient(url,key,{auth:{persistSession:false,autoRefreshToken:false}});const engineVersion=String(body.engineVersion||"v57");
