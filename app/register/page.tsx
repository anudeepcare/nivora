...
export default function Register(){
 ...
 return <AuthShell eyebrow="Get started" title="Create account" subtitle="Build a private workspace for research, positions and market decisions." storyTitle="Your capital deserves a clearer decision system." storyBody="Research less noise. Understand the evidence, the action, the price plan and what could make the thesis wrong." points={["Clear action and price plan","Simple, Investor and Pro depth","Transparent model and data limitations"]}>
