...
def record_history(rows):
    ...
    for x in rows:
        try:
            ...
            row['engine_version']='v60-screening-1';row['weights_version']='v60-screening-1';row['valuation_version']='v60-screening-archetype-1';row['archetype']=x.get('archetype');row['benchmark_symbol']='SPY'
