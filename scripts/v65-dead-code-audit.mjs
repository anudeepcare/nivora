...
for(const f of fs.readdirSync(".")){if((/^README_V\d/i.test(f)||/^V\d.*(?:RELEASE|AUDIT|ARCHITECTURE).*\.md$/i.test(f))&&!["V65_RELEASE.md","V65_3_RELEASE.md"].includes(f))problems.push(`${f}: legacy release document left in root`)}
